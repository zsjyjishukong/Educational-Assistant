  ...
  <div class="about-us-page">
    <yd-layout>
      ...
      <div class="describe">
        ...
        <div style="height:0.5rem; line-height: 0.5rem; text-align: center; margin-top: 0.3rem;" @click="openUrl('https://github.com/jy-educational-administration-assistant', '_blank')">
